...
#first prompt:
    #Using python and tkinter, create two windows. I want to be able to jump between the two windows with buttons. 
    #For example, window one should have a button to window 2. 
    #And window 2 should have a button to return to window 1.

#second prompt:
    #do this all again but with 3 windows

#third prompt:
    #Change it to 2 buttons on each window. In any given window, i 
    #should have the option to select on of the other two windows.
